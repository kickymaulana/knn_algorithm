            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control"  name="nama_lengkap" value="<?php echo set_value("nama_lengkap" , $user->nama_lengkap   );  ?>"  />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control"  name="alamat" value="<?php echo set_value("alamat",$user->alamat  ); ?>"  />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control"  name="no_hp" value="<?php echo set_value("no_hp" , $user->no_hp); ?>" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" step="any" class="form-control"  name="umt1" value="<?php echo set_value("umt1" , $user->umt1); ?>" />
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label for="" class="control-label">Umt 2</label>
                        </div>
                        <div class="col-md-8">
                            <input type="number" step="any" class="form-control"  name="umt2" value="<?php echo set_value("umt2" , $user->umt2); ?>" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" step="any" class="form-control"  name="nmt1" value="<?php echo set_value("nmt1" , $user->nmt1); ?>" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="number" step="any" class="form-control"  name="nmt2" value="<?php echo set_value("nmt2" , $user->nmt2 ); ?>" />
